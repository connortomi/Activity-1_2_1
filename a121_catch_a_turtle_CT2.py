...
def manage_leaderboard():
  ...
  if (len(leader_scores_list) < 5 or score > leader_scores_list[4]):
    ...
    lb.draw_leaderboard(leader_names_list, leader_scores_list, True, johnathan, score)

  else:
    lb.draw_leaderboard(leader_names_list, leader_scores_list, False, johnathan, score)
